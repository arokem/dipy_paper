...
free and open source software, written in the Python language, and is part 
of a larger community knows as \url{nipy.org}. This is a growing
team of scientists and developers focusing on sharing code on different modalities
of brain imaging. 
...
Dipy github repository is managed under this organization\footnote{\url{http://github.com/nipy/dipy}}).  The community provides support for the use and
development of these software tools through a mailing list\footnote{\url{dipy.org/subscribe.html}}, and this mailing list is also a good place to discuss other Python and neuroimaging related issues.
...
~\ref{Fig:gh_stats}, with contributors based in at least 7 different academic
institutions in 5 countries (Canada, UK, USA, Italy and South-Africa).
