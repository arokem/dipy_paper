...
showing that Dipy, although a new project, can fill many of the steps needed to do a complete 
dMRI analysis.

Dipy is free and open source software and it is part of a larger community found in \url{nipy.org}. 
This is a growing team of scientists and developers focusing on sharing code concerning different modalities
...
with contributors based in at least 7 different academic
...
Ultimately, this paper shares with you our excitement of developing Dipy and welcomes 
you to participate in the project. We strongly hope that more scientists will join 
Dipy by using the software, giving us feedback so that we can make it better, 
or even better by sharing their code and joining the developers team. We think that 
in order to solve the hard problem of brain mapping a wide and open participation is 
