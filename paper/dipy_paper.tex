...
approximated not the full brain.
...
streamlines after they have been created.
...
module which is based on the Visualization Toolkit (VTK) \citep{schroeder:01} and we call
...
fvtk.show(renderer)
\end{python}
The function \texttt{streamtube} was also the one we used to create Fig.~\ref{Fig:fornix} and \ref{Fig:pretty_streamlines}. The most commonly used visualization functions are given in Tab.~\ref{fvtk_table}.
