...
projects aimed at characterizing the connectome, based on DWI, as well as fMRI
measurements \cite{VanEssen2013}.
...
information in each voxel to represent a distribution . In these algorithms, a
trajectory of fibers in every location is sampled from this distribution. The
algorithm may therefore give different sets of `fibers` on different realizations
of the algorithm. 
