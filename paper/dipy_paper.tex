...
\emph{Diffusion MRI} (dMRI) \citep{merboldt-hanicke-etal:85,
  lebihan-breton:85, taylor-bushell:85, callaghan:91}
is an MRI technique that provides information
...
thousand papers published in 2012 (Performing the query " XXX YYY" in PubMed). This popularity is
