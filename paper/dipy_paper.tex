...
and the recent stack of neuroimaging modules\footnote{\url{http://nipy.org}}
...
an implementation of an Array class \citep{van_numpy:11}. Numpy arrays are used
...
aim to help the Dipy code-base grow, while preserving its quality.

Through this work ethic, Dipy has attracted an international and
multi-departmental team of contributors from different levels
...
the results of the analysis. In subsequent sections, we will use this
